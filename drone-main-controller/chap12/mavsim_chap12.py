...
import sys
sys.path.append('..')
sys.path.append('~/OneDrive/Documents/mavsim_template_files/mavsim_python')
sys.path.append('c:\\Users\\tbmh1\\OneDrive\\Documents\\mavsim_template_files\\mavsim_python')
